    ...
    public class DemoController : Controller
    {
        ...
        public ActionResult BasicBar()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                .SetSeries(new[]
                {
                    new Series { Name = "Year 1800", Data = new Data(new object[] { 107, 31, 635, 203 }) },
        ...
        public ActionResult StackedColumn()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                .SetXAxis(new XAxis { Categories = new[] { "Jan", "Fev", "Mar", "Mai","Abr" } })
                .SetYAxis(new YAxis
                {
                    Min = 0,
                    Title = new YAxisTitle { Text = "Total fruit consumption" },
        ...
        public ActionResult StackedPercentageColumn()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                .SetSeries(new[]
                {
                    new Series { Name = "John", Data = new Data(new object[] { 5, 3, 4, 7, 2 }) },
                    new Series { Name = "Jane", Data = new Data(new object[] { 2, 2, 3, 2, 1 }) },
                    new Series { Name = "Jeff", Data = new Data(new object[] { 2, 2, 3, 2, 1 }) },
                    new Series { Name = "Joe", Data = new Data(new object[] { 3, 4, 4, 2, 5 }) }
                });
        ...
        public ActionResult Waterfall()
        {
            Highcharts chart = new Highcharts("chart")
                ...
                .SetLegend(new Legend { Enabled = false })
                .SetTooltip(new Tooltip { PointFormat = "<b>{point.y}</b>" })
                .SetSeries(new Series
                {
                    ...
                    Data = new Data(new[]
                    {
                        new Point { Name = "Start", Y = 1200 },
                        new Point { Name = "Product Revenue", Y = 5690 },
                        new Point { Name = "Service Revenue", Y = -2310 },
                        new Point { Name = "Positive Balance", Color = Color.FromName("Highcharts.getOptions().colors[1]"), IsIntermediateSum = true },
                        new Point { Name = "Fixed Costs", Y = -3420 },
                        new Point { Name = "Variable Costs", Y = -2330 },
                        new Point { Name = "Variable Costs", Y = 6330 },
